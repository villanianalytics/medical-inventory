...
To build the final jar and optimize the MedicalInventory application for production, run:
...
Then navigate to [http://localhost:8075](http://localhost:8075) in your browser.
